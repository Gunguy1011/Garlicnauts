...
public class ActionOpenCurtains : Action
{
    ...
    public ActionOpenCurtains(GameObject objectM, float duration = 0.0f, float time = 0.0f, EaseType type = 0, bool block_ = false, int blocknum_ = 0)
    {
        Actoor = objectM;
        Duration_ = duration;
        Time_ = time;
    ...
    override public bool Update()
    {
        ...
        rightCurtainStartPosition = new Vector3(13.30f, 12.6f, -22.2f);
        rightCurtainEndPosition = new Vector3(20f, 12.6f, -22.2f);
        leftCurtainStartPosition = new Vector3(3.5f, 12.6f, -22.2f);
        leftCurtainEndPosition = new Vector3(-5f, 12.6f, -22.2f);
        topCurtainEndPosition = new Vector3(8.10f, 14.35f, -22.45f);
        topCurtainStartPosition = new Vector3(8.10f, 12.86f, -22.45f);
